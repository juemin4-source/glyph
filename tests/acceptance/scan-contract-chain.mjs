...
const ENTITIES = [
  {
    name: 'PremiseCard',
    contractFile: 'docs/contracts/premise.contract.ts',
    apiFile: 'api/premiseApi.ts',
    commandsFile: 'src-tauri/src/premise_commands.rs',
    modelsStruct: 'PremiseCard',
    dbPrefix: 'premise_card',
    uiFiles: ['features/canvas-01-premise/PremiseEntryGate.tsx'],
  ...
  {
    name: 'StructureNode',
    contractFile: 'docs/contracts/structure.contract.ts',
    apiFile: 'api/structureApi.ts',
    commandsFile: 'src-tauri/src/structure_commands.rs',
    modelsStruct: 'StructureNode',
    dbPrefix: 'structure_node',
    uiFiles: ['features/canvas-02-structure/StructureFlowView.tsx', 'features/canvas-02-structure/StructureFlowPlaceholder.tsx'],
  ...
  {
    name: 'WorldRule',
    contractFile: 'docs/contracts/setting.contract.ts',
    apiFile: 'api/settingApi.ts',
    commandsFile: 'src-tauri/src/setting_commands.rs',
    modelsStruct: 'WorldRule',
    dbPrefix: 'world_rule',
    uiFiles: ['features/canvas-03-setting/WorldRulePanel.tsx'],
  ...
  },
  {
    ...
    uiFiles: ['features/canvas-03-setting/CharacterPanel.tsx'],
  ...
  },
  {
    ...
    uiFiles: ['features/canvas-03-setting/FactionPanel.tsx'],
  ...
  {
    name: 'ChapterPacket',
    contractFile: 'docs/contracts/chapter-packet.contract.ts',
    apiFile: 'api/chapterPacketApi.ts',
  ...
  },
  {
    ...
    contractFile: 'docs/contracts/decision-log.contract.ts',
    apiFile: 'api/decisionLogApi.ts',
  ...
  {
    name: 'AiContext',
    contractFile: 'docs/contracts/ai-context.contract.ts',
    apiFile: 'api/aiContextApi.ts',
  ...
  {
    name: 'AiRouter',
    contractFile: 'docs/contracts/ai-router.contract.ts',
    apiFile: 'api/aiContextApi.ts',
    commandsFile: 'src-tauri/src/ai_commands.rs',
  ...
  {
    name: 'AiParser',
    contractFile: 'docs/contracts/ai-parser.contract.ts',
    apiFile: 'api/', // parser is pure-JS, no API layer
    commandsFile: 'src-tauri/src/ai_commands.rs',
  ...
  },
  {
    ...
    contractFile: 'docs/contracts/ai-registry.contract.ts',
    apiFile: 'api/aiControlCenterApi.ts',
    commandsFile: 'src-tauri/src/ai_commands.rs',
  ...
  // ===== v2.1.0 Method Entities (ACTIVE — implemented and verified by T-007 final gate) =====
  {
    ...
    uiFiles: [
      'features/canvas-01-premise/PremiseEntryGate.tsx',
      'features/canvas-01-premise/PremiseStepWishlist.tsx',
      'features/canvas-01-premise/PremiseStepInternExtern.tsx',
      'features/canvas-01-premise/PremiseStepVariants.tsx',
      'features/canvas-01-premise/PremiseStepReaderQA.tsx',
      'features/canvas-01-premise/PremiseStepGenreJudgment.tsx',
    ],
  ...
  },
  {
    ...
    dbPrefix: 'structure_node',
    uiFiles: [
      'features/canvas-02-structure/StructureGraph.tsx',
      'features/canvas-02-structure/StructureBreadcrumb.tsx',
      'features/canvas-02-structure/NodeDetailSidebar.tsx',
      'features/canvas-02-structure/nodes/BookNode.tsx',
      'features/canvas-02-structure/nodes/ShiweiNode.tsx',
      'features/canvas-02-structure/nodes/HouNode.tsx',
      'features/canvas-02-structure/nodes/ZhangNode.tsx',
    ],
  ...
  },
  {
    ...
    uiFiles: [
      'features/canvas-03-setting/SparrowStepList.tsx',
      'features/canvas-03-setting/SparrowStepCard.tsx',
      'features/canvas-03-setting/SparrowProtagonistSteps.tsx',
    ],
  ...
  // filled by T-004. Marked PENDING so scanner skips backend verification for now.
  {
    ...
    contractFile: 'docs/contracts/pipeline-integrator.contract.ts',
    apiFile: 'api/premiseApi.ts',
    commandsFile: 'src-tauri/src/pipeline_commands.rs',
    modelsStruct: 'TimestampRecord',
    dbPrefix: 'pipeline',
    uiFiles: [
      'features/common/pipeline-indicator/PipelineIndicator.tsx',
      'src/hooks/useUpstreamDetection.ts',
      'features/canvas-03-setting/SparrowStepList.tsx',
      'features/canvas-04-packet/ChapterPacketCanvas.tsx',
  ...
  },
  {
    ...
    uiFiles: [
      'features/canvas-04-packet/PacketDetailModeSelector.tsx',
      'features/canvas-04-packet/PacketSketchView.tsx',
      'features/canvas-04-packet/PacketRefinedView.tsx',
    ],
  ...
  // References the mapping function + modified UI files.
  {
    ...
    contractFile: 'docs/contracts/premise.contract.ts',
    apiFile: 'features/common/pipeline/premise-to-contract.ts',
    commandsFile: 'src-tauri/src/premise_commands.rs',
    modelsStruct: 'PremiseCard',
    dbPrefix: 'premise_to_contract',
    uiFiles: [
      'features/common/pipeline/premise-to-contract.ts',
      'features/canvas-04-packet/ChapterPacketCanvas.tsx',
      'features/canvas-01-premise/PremiseEntryGate.tsx',
    ],
    commands: [],
